...
public abstract class MixinRenderDroppedItem extends Render<EntityItem> {

    @Shadow
    protected abstract int func_177078_a(ItemStack stack);

    public MixinRenderDroppedItem(RenderManager renderManager) {
        super(renderManager);
    }
    float rotAmount = 0F;
    /**
    ...
    private int func_177077_a(EntityItem itemIn, double p_177077_2_, double p_177077_4_, double p_177077_6_, float p_177077_8_, IBakedModel p_177077_9_) {
        ...
        if(ModInstances.getItemPhysics().isEnabled()) {
            ...
            if (item == null) {
                ...
                if (!itemIn.onGround) {
                    rotAmount = ((float) itemIn.getAge() * speed) % 360;
