...
public class GuiUtils {
    ...
    public static void drawRoundBG(GuiScreen screen, boolean blurred){
        ...
        if(blurred){
            and1558.guiUtils.customBlur = true;
            ...
            and1558.guiUtils.customBlur = false;
        }
    ...
    public static void drawRoundBGMediumSize(GuiScreen screen, boolean blurred){
        ...
        if(blurred){
            and1558.guiUtils.customBlur = true;
            ScaledResolution sc = new ScaledResolution(Minecraft.getMinecraft());
            BlurUtils.renderBlurredBackground(sc.getScaledWidth(), sc.getScaledHeight(), 150, 50, screen.width - 150 - 150, screen.height - 50 - 50, 7);
        }else if(!blurred){
            and1558.guiUtils.customBlur = false;
        }
        GlStateManager.enableBlend();
