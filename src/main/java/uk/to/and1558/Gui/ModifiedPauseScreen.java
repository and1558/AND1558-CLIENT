...
public class ModifiedPauseScreen extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(new GuiButton(8, this.width / 2 - 100, this.height / 4 + 72 + i, "Mod Options"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        float f1 = (this.field_146444_f % 10 + partialTicks) / 10.0f;
        f1 = MathHelper.sin(f1 * 3.141593f * 2.0f) * 0.2f + 0.8f;
        final int k = (int)(255.0f * f1);
        if (this.mc.isSingleplayer()) {
            if (this.field_146444_f < 20) {
                this.drawString(this.fontRendererObj, "Saving Level...", 15, this.height - 20, k << 16 | k << 8 | k);
            }
        }
        else if (this.field_146444_f < 10) {
            this.drawString(this.fontRendererObj, "Sending Player Save Pos Packet...", 15, this.height - 20, k << 16 | k << 8 | k);
        }
    }
}