...
public class WebServer {
     ...
     */
    public static void initWebServer(MSAuthGUI gui) {
        try {
            server = HttpServer.create(new InetSocketAddress(6921), 0);
            server.createContext("/microsoft/complete", new MyHandler(gui));
    ...
    public static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            ...
            if (queryParams.containsKey("code")) {
                ...
                authGUI.err = SessionUtils.recieveResponse(code);
            } else {
