 ...
 */
package uk.to.and1558.Plugins.openauth.microsoft;
...
import uk.to.and1558.Plugins.openauth.microsoft.model.request.MinecraftLoginRequest;
import uk.to.and1558.Plugins.openauth.microsoft.model.request.XSTSAuthorizationProperties;
import uk.to.and1558.Plugins.openauth.microsoft.model.request.XboxLiveLoginProperties;
import uk.to.and1558.Plugins.openauth.microsoft.model.request.XboxLoginRequest;
import uk.to.and1558.Plugins.openauth.microsoft.model.response.MicrosoftRefreshResponse;
import uk.to.and1558.Plugins.openauth.microsoft.model.response.MinecraftLoginResponse;
import uk.to.and1558.Plugins.openauth.microsoft.model.response.MinecraftProfile;
import uk.to.and1558.Plugins.openauth.microsoft.model.response.MinecraftStoreResponse;
import uk.to.and1558.Plugins.openauth.microsoft.model.response.XboxLoginResponse;
...
public class MicrosoftAuthenticator
{
    ...
    public MicrosoftAuthResult loginWithTokens(AuthTokens tokens) throws MicrosoftAuthenticationException
    {
        ...
        and1558.logger.info("Waiting for response...");
        ...
        and1558.logger.info("Storing Response...");
        ...
        and1558.logger.info("Deleting response and tokens and Logging in...");
