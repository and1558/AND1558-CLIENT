...
import owo.aydendevy.Gui.impl.UnicodeFontRenderer;
...
public class SplashScreen {
    ...
    public static void drawSplash(TextureManager tm) {
        ...
        if (splash == null) splash = new ResourceLocation("and1558/images/splash.png");
    ...
    private static void drawProgress() {
        ...
        if (ufr == null) ufr = UnicodeFontRenderer.getFontOnPC("Arial", 20);
        ...
        Gui.drawRect(0, sr.getScaledHeight() - 35, sr.getScaledWidth(), sr.getScaledHeight(), new Color(0, 0, 0, 90).getRGB());
