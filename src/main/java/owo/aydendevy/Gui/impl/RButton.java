...
import owo.aydendevy.Renderer.GuiUtils;
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible)
        {
            ...
            else if (this.hovered)
            {
                ...
                GuiUtils.drawRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, this.radius, 0x99000000);
                GuiUtils.drawHollowRoundedRect(this.xPosition, this.yPosition, this.xPosition + this.width, this.yPosition + this.height, this.radius, 0xFF00FF00);
                j = 16777120;
            }
