...
public class GLUtils {
    ...
    public int textureIDSet = -1;
    int textureID = -1;
    public int bindTexture(BufferedImage image){
    ...
    public int loadTexture(BufferedImage image){
        ...
        buffer = BufferUtils.createByteBuffer(image.getWidth() * image.getHeight() * BYTES_PER_PIXEL); //4 for RGBA, 3 for RGB
