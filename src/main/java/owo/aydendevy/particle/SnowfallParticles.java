package owo.aydendevy.club.aetherium.api.particle;
...
import owo.aydendevy.Plugins.GuiUtils;
...
public class SnowfallParticles {
     ...
     */
    public void render(boolean tinted) {
        update();
        ...
        for (Particle particle : particles) {
            ...
            if(tinted)
                GuiUtils.drawRoundedRect(
                        ...
                        new Color(127, 127, 127, (int) (particle.getAlpha() * 255)).getRGB()
                );
            else
            GuiUtils.drawRoundedRect(
                    particle.getX(), particle.getY(),
